...
function valuateProperty(valuateProperty){
    ...
    .then(function (mortgageValuationRegistry){
        ...
        // check if you've already created a mortgage valuation for the selected property and deny if already created
...
function validateMortgage(validateMortgage){
        ...
        // calculate mortgage amount, check if sufficient funds
